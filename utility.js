...
exports.initialize_commands = function(initialize) { // Maybe should rename. 
	...
	const commands = [
		...
		new SlashCommandBuilder().setName('strike').setDescription('\nRemoves songs from the first index given until the second.').addIntegerOption(opt=>opt.setName('from').setDescription('The index of the song to be removed.').setRequired(true)).addIntegerOption(opt=>opt.setName('until').setDescription('The index of the last song to be removed.').setRequired(true)),
		...
		new SlashCommandBuilder().setName('list').setDescription('\nLists playlist.'),
		...
		new SlashCommandBuilder().setName('join').setDescription('\nJoins the voice channel that you\'re in.'),
		...
		new SlashCommandBuilder().setName('auto').setDescription('\nToggles autoplay feature.'),
		...
		new SlashCommandBuilder().setName('set').setDescription('\nSets the volume.').addNumberOption(option => option.setName('level').setDescription('The new volume level.').setRequired(true)),
		...
		new SlashCommandBuilder().setName('\ntimestamp').setDescription('Returns the amount of time the current song has been playing for.'),
